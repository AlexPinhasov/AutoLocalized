...
func validateLocalizationKeysMatch(in localizationFiles: [LocalizationStringsFile]) {
...
func validateMissingKeys(from files: [File], in localizationFiles: [LocalizationStringsFile]) {
...
func validateDeadKeys(from files: [File], in localizationFiles: [LocalizationStringsFile]) {
...
/// - Parameters:
///   - localizationFiles: Array of LocalizableFiles
func validateDuplicateKeys(in localizationFiles: [LocalizationStringsFile]) {
    localizationFiles.forEach { file in
